...
const SzczepieniaByPunkt= () => {
    ...
    const myPunkt = szczepienieData.filter(e => {
        return e.punkt == sessionStorage.getItem("punkt") && new Date(e.dataSzczepienia) >= new Date();
    })
    ...
    return (
        <div className="szczepieniaPunktMain">
            ...
            <div className="szczepieniaPunkt">
                {displaySzczepienie.length > 0 && <u><h1>Nadchodzące szczepienia pacjentów</h1></u>}
...
export default SzczepieniaByPunkt; 